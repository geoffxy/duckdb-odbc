...
TEST_CASE("Test row-wise fetch of TIMESTAMP array binding", "[odbc]") {
    ...
    EXECUTE_AND_CHECK("SQLExecDirect", hstmt, SQLExecDirect, hstmt,
                      ConvertToSQLCHAR("DROP TABLE IF EXISTS ts_array_test"), SQL_NTS);
    EXECUTE_AND_CHECK("SQLExecDirect", hstmt, SQLExecDirect, hstmt,
                      ConvertToSQLCHAR("CREATE TABLE ts_array_test (col1 TIMESTAMP)"), SQL_NTS);

    for (int i = 0; i < ROW_ARRAY_SIZE; ++i) {
        char buf[128];
        snprintf(buf, sizeof(buf), "INSERT INTO ts_array_test VALUES ('2000-01-01 00:00:%02d')", i);
    ...
    EXECUTE_AND_CHECK("SQLSetStmtAttr (SQL_ATTR_ROW_BIND_TYPE)", hstmt, SQLSetStmtAttr, hstmt, SQL_ATTR_ROW_BIND_TYPE,
                      reinterpret_cast<SQLPOINTER>(sizeof(SQL_TIMESTAMP_STRUCT)), 0);
    ...
    EXECUTE_AND_CHECK("SQLBindCol (TIMESTAMP)", hstmt, SQLBindCol, hstmt, 1, SQL_C_TYPE_TIMESTAMP, &ts_array[0],
                      sizeof(ts_array[0]), &ts_ind[0]);

    EXECUTE_AND_CHECK("SQLExecDirect (SELECT)", hstmt, SQLExecDirect, hstmt,
                      ConvertToSQLCHAR("SELECT * FROM ts_array_test ORDER BY col1"), SQL_NTS);
...
TEST_CASE("Test row-wise fetch of DATE array binding", "[odbc]") {
    SQLHANDLE env;
    SQLHANDLE dbc;
    HSTMT hstmt = SQL_NULL_HSTMT;
    ...
    EXECUTE_AND_CHECK("SQLExecDirect", hstmt, SQLExecDirect, hstmt,
                      ConvertToSQLCHAR("DROP TABLE IF EXISTS date_array_test"), SQL_NTS);
    EXECUTE_AND_CHECK("SQLExecDirect", hstmt, SQLExecDirect, hstmt,
                      ConvertToSQLCHAR("CREATE TABLE date_array_test (col1 DATE)"), SQL_NTS);

    for (int i = 0; i < ROW_ARRAY_SIZE; ++i) {
        char buf[128];
        snprintf(buf, sizeof(buf), "INSERT INTO date_array_test VALUES ('2000-01-%02d')", i + 1);
        EXECUTE_AND_CHECK("SQLExecDirect (INSERT)", hstmt, SQLExecDirect, hstmt, ConvertToSQLCHAR(buf), SQL_NTS);
    }
    ...
    EXECUTE_AND_CHECK("SQLSetStmtAttr (SQL_ATTR_ROW_BIND_TYPE)", hstmt, SQLSetStmtAttr, hstmt, SQL_ATTR_ROW_BIND_TYPE,
                      reinterpret_cast<SQLPOINTER>(sizeof(SQL_DATE_STRUCT)), 0);
    EXECUTE_AND_CHECK("SQLSetStmtAttr (SQL_ATTR_ROW_ARRAY_SIZE)", hstmt, SQLSetStmtAttr, hstmt, SQL_ATTR_ROW_ARRAY_SIZE,
                      reinterpret_cast<SQLPOINTER>(ROW_ARRAY_SIZE), 0);
    EXECUTE_AND_CHECK("SQLSetStmtAttr (SQL_ATTR_ROW_STATUS_PTR)", hstmt, SQLSetStmtAttr, hstmt, SQL_ATTR_ROW_STATUS_PTR,
                      row_array_status, 0);
    ...
    EXECUTE_AND_CHECK("SQLBindCol (DATE)", hstmt, SQLBindCol, hstmt, 1, SQL_C_TYPE_DATE, &date_array[0],
                      sizeof(date_array[0]), &date_ind[0]);

    EXECUTE_AND_CHECK("SQLExecDirect (SELECT)", hstmt, SQLExecDirect, hstmt,
                      ConvertToSQLCHAR("SELECT * FROM date_array_test ORDER BY col1"), SQL_NTS);
    EXECUTE_AND_CHECK("SQLFetchScroll", hstmt, SQLFetchScroll, hstmt, SQL_FETCH_NEXT, 0);
...
TEST_CASE("Test row-wise fetch of TIME array binding", "[odbc]") {
    SQLHANDLE env;
    SQLHANDLE dbc;
    HSTMT hstmt = SQL_NULL_HSTMT;
    ...
    EXECUTE_AND_CHECK("SQLExecDirect", hstmt, SQLExecDirect, hstmt,
                      ConvertToSQLCHAR("DROP TABLE IF EXISTS time_array_test"), SQL_NTS);
    EXECUTE_AND_CHECK("SQLExecDirect", hstmt, SQLExecDirect, hstmt,
                      ConvertToSQLCHAR("CREATE TABLE time_array_test (col1 TIME)"), SQL_NTS);

    for (int i = 0; i < ROW_ARRAY_SIZE; ++i) {
        char buf[128];
        snprintf(buf, sizeof(buf), "INSERT INTO time_array_test VALUES ('0%d:0%d:0%d')", i, i, i);
        EXECUTE_AND_CHECK("SQLExecDirect (INSERT)", hstmt, SQLExecDirect, hstmt, ConvertToSQLCHAR(buf), SQL_NTS);
    }
    ...
    EXECUTE_AND_CHECK("SQLSetStmtAttr (SQL_ATTR_ROW_BIND_TYPE)", hstmt, SQLSetStmtAttr, hstmt, SQL_ATTR_ROW_BIND_TYPE,
                      reinterpret_cast<SQLPOINTER>(sizeof(SQL_TIME_STRUCT)), 0);
    EXECUTE_AND_CHECK("SQLSetStmtAttr (SQL_ATTR_ROW_ARRAY_SIZE)", hstmt, SQLSetStmtAttr, hstmt, SQL_ATTR_ROW_ARRAY_SIZE,
                      reinterpret_cast<SQLPOINTER>(ROW_ARRAY_SIZE), 0);
    EXECUTE_AND_CHECK("SQLSetStmtAttr (SQL_ATTR_ROW_STATUS_PTR)", hstmt, SQLSetStmtAttr, hstmt, SQL_ATTR_ROW_STATUS_PTR,
                      row_array_status, 0);
    ...
    EXECUTE_AND_CHECK("SQLBindCol (TIME)", hstmt, SQLBindCol, hstmt, 1, SQL_C_TYPE_TIME, &time_array[0],
                      sizeof(time_array[0]), &time_ind[0]);

    EXECUTE_AND_CHECK("SQLExecDirect (SELECT)", hstmt, SQLExecDirect, hstmt,
                      ConvertToSQLCHAR("SELECT * FROM time_array_test ORDER BY col1"), SQL_NTS);
    EXECUTE_AND_CHECK("SQLFetchScroll", hstmt, SQLFetchScroll, hstmt, SQL_FETCH_NEXT, 0);
